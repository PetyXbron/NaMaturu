---
title: Biosféra
description: Otázka 9 - Planetární diferenciace biosféry
state: 2
---

# **Planetární diferenciace biosféry**
...
<table>
    <thead>
        <tr>
            <th colspan="2" class="colored">Biom</th>
            <th class="colored">Klima</th>
            <th class="colored">Vegetace</th>
            <th class="colored">Živočichové</th>
            <th class="colored">Lokalita</th>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td colspan="2" class="colored">Tropický deštný les</td>
            <td>Teplé, vlhké, stálé srážky</td>
            <td>Vysoké stromy, liány, epifyty</td>
            <td>Opice, papoušci, jaguáři, hmyz</td>
            <td>Amazonie, Kongo, JV Asie</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Teplé, období sucha a dešťů</td>
            <td>Traviny, rozptýlené stromy</td>
            <td>Sloni, lvi, zebry, antilopy</td>
            <td>Afrika, Jižní Amerika, Austrálie</td>
        </tr>
        <tr>
            <td rowspan="4" class="colored">Poušť</td>
            <td class="colored">Poušť</td>
            <td>Horké/studené, suché</td>
            <td>Kaktusy, sukulenty, řídká vegetace</td>
            <td>Velbloudi, hadi, ještěrky</td>
            <td>Sahara, Gobi, Atacama</td>
        </tr>
        <tr>
            <td class="colored">Hamada</td>
            <td>Horké/studené, suché</td>
            <td>Skály, minimální vegetace</td>
            <td>Plazi, drobní savci</td>
            <td>Sahara, Arabská poušť</td>
        </tr>
        <tr>
            <td class="colored">Reg</td>
            <td>Horké/studené, suché</td>
            <td>Štěrk, řídká vegetace</td>
            <td>Hlodavci, plazi</td>
            <td>Sahara, Íránská poušť</td>
        </tr>
        <tr>
            <td class="colored">Erg</td>
            <td>Horké/studené, suché</td>
            <td>Písek, řídká vegetace</td>
            <td>Hadi, brouci, velbloudi</td>
            <td>Sahara, Rub al-Chálí</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Mírné, suché léto, chladná zima</td>
            <td>Traviny, málo stromů</td>
            <td>Bizoni, vlci, hlodavci</td>
            <td>Eurasie, Severní Amerika</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>Chladné, dlouhá zima, krátké léto</td>
            <td>Borovice, smrky, jedle</td>
            <td>Medvědi, losi, rysi</td>
            <td>Sibiř, Kanada, Skandinávie</td>
        </tr>
        <tr>
            <td colspan="2" class="colored">Tundra</td>
            <td>Velmi chladné, krátké léto</td>
            <td>Mechy, lišejníky, nízké keře</td>
            <td>Sob, polární liška, sovy</td>
            <td>Arktida, severní Kanada, Sibiř</td>
        </tr>
        <tr>
            <td colspan="2" class="colored">Horské oblasti</td>
            <td>Proměnlivé, chladné s výškou</td>
            <td>Alpínské louky, jehličnany</td>
            <td>Kamzíci, orli, svišti</td>
            <td>Alpy, Andy, Himálaj</td>
        </tr>
    </tbody>
</table>
